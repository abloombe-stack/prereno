/*
  ...
  1. Demo Users
    - Client: client@prereno.demo / demo123!
    - Contractor: contractor@prereno.demo / demo123!
    - Landlord: landlord@prereno.demo / demo123!
    - Admin: admin@prereno.demo / demo123!

  2. Sample Data
    - Addresses for each user
    - Pricing data for major Texas cities
...
-- Note: Demo users will be created via the auth trigger when they sign up
-- This ensures proper auth.users entries are created first

-- Insert audit log for schema creation
INSERT INTO audit_logs (action, entity_type, metadata) VALUES (
  'schema_created',
  'system',
  '{"tables_created": 16, "policies_created": 20, "indexes_created": 15}'::jsonb
);